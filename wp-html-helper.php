...
// image default alt
if (!function_exists('restan_img_default_alt')) {
	function restan_img_default_alt($url = '')
	{
...
// Image Tag
if (!function_exists('restan_img_tag')) {
	function restan_img_tag(array $args)
	{
		...
		if (!empty($args['alt'])) {
			...
			$alt = restan_img_default_alt($site_name);
		}
...
// Anchor Tag
if (!function_exists('restan_anchor_tag')) {
	function restan_anchor_tag(array $args)
	{
...
// Heading Tag
if (!function_exists('restan_heading_tag')) {
	function restan_heading_tag(array $args)
	{

		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => __('Write Something', 'restan'),
			'class'  	  => '',
			'id' 	 	  => '',
			'data-animate' => '',
			'data-delay'  => '',
...
// Paragraph Tag
if (!function_exists('restan_paragraph_tag')) {
	function restan_paragraph_tag(array $args)
	{
...
// Other Tag
if (!function_exists('restan_span_tag')) {
	function restan_span_tag(array $args)
	{
