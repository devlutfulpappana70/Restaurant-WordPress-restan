...
// the opt_name is set to restan_opt.  Please replace it if change your opt_name name.
add_action( 'redux/page/restan_opt/enqueue', 'restan_faIconFont' );
function restan_faIconFont() {
	
  //  Font awesome enqueue
  wp_enqueue_style( 'font-awesome', RESTAN_DIR_CSS_URI.'font-awesome.min.css', array(), '4.7.0', 'all' );
  
  // Redux admin css enqueue
  wp_enqueue_style( 'restan-redux-admin', RESTAN_DIR_URI.'inc/redux-custom-field/assets/restan.redux.admin.css', array(), '1.0' );
  
  // Redux admin js enqueue
  wp_enqueue_script( 'restan-redux-admin', RESTAN_DIR_URI.'inc/redux-custom-field/assets/restan.redux.admin.js', array( 'jquery' ), '1.0', true );
